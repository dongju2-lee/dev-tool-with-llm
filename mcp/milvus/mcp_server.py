...
mcp = FastMCP(
    "Milvus",  # MCP 서버 이름
    instructions="Milvus 벡터 데이터베이스와 상호작용하기 위한 도구입니다. 컬렉션 관리, 벡터 검색, 데이터 삽입 등의 기능을 제공합니다.",
...
if __name__ == "__main__":
    ...
    # 서버 시작 메시지 출력
    logger.info("Milvus MCP 서버 시작 중...")
    logger.info("포트 8012에서 SSE 방식으로 수신 대기 중...")
    print("Milvus MCP 서버가 실행 중입니다...")
    print("포트 8012에서 SSE 방식으로 수신 대기 중...")
